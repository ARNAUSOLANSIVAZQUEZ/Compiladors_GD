...
char* handle_include_program_files(char* reading_buffer, PatternMatcher* pattern_match_base, MultiString* ifdef_ms, bool process_comments, bool process_directives) {
    ...
    char* ret = preprocess(raw_include, &size_include, pattern_match_base, ifdef_ms, process_comments, process_directives);
...
char* handle_include_compiler_files(char* reading_buffer, PatternMatcher* pattern_match_base, MultiString* ifdef_ms, bool process_comments, bool process_directives) {
    char include_dir[MAX_LENGTH_INCLUDE];
    char* raw_include;
...
void pre_handle_compile_file(char* reading_buffer, int* reading_buffer_index, char** writing_buffer,
                             size_t* writing_buffer_len, int* writing_index, PatternMatcher* pattern_match_static, MultiString* ifdef_ms, bool process_comments, bool process_directives) {
    char* include_text = handle_include_compiler_files(&reading_buffer[*reading_buffer_index], pattern_match_static, ifdef_ms, process_comments, process_directives);
...
void pre_handle_include_file(char* reading_buffer, int* reading_buffer_index, char** writing_buffer,
    ...
    char* include_text = handle_include_program_files(&reading_buffer[*reading_buffer_index + 1], pattern_match_static, ifdef_ms, process_comments, process_directives);
    //^should return direcly what needs to be inserted in the writing buffer
    if(include_text == NULL){
